#!/usr/bin/env python3
"""
fix_windsor_urls.py - Remediate 3 Windsor properties. Windsor's individual
domains (windsorkennesaw.com, windsoroldfourthward.com) just link users to
windsorcommunities.com/properties/<slug>/floorplans/ for actual availability,
which does host a SightMap iframe. The brand search page (`/find-apartments/`)
obviously can't be scraped directly.

"565 Hank by Windsor" → this is the old name; the property was discovered
as "Windsor 565 Hank" on their portfolio page. Verifying that URL.
"""
...
log = logging.getLogger("fix_windsor_urls")
...
REMEDIATIONS: dict[str, str] = {
    "Windsor Kennesaw":         "https://www.windsorcommunities.com/properties/Windsor-Kennesaw/floorplans/",
    "Windsor Old Fourth Ward":  "https://www.windsorcommunities.com/properties/Windsor-Old-Fourth-Ward/floorplans/",
    "565 Hank by Windsor":      "https://www.windsorcommunities.com/properties/565-Hank-by-Windsor/floorplans/",
}
...
def main() -> None:
    ...
    for name, new_url in REMEDIATIONS.items():
        ...
        progress_record = {
            ...
            "notes": f"Windsor remediation: {pricing_info.get('notes', '')}; {scraper_note}",
