#!/usr/bin/env python3
"""
fix_bell_abbey_urls.py - Remediate 3 more properties:
  * Bell Morningside, Bell Perimeter Center → DB had the securecafenet login
    walls; Bell runs proper marketing sites for both on bellmorningside.com
    and bellperimetercenter.com.
  * Abbey at Eagles Landing → DB URL ended in /apply (the application form);
    the correct floorplans URL uses `/floor-plans` (hyphenated).
"""
...
log = logging.getLogger("fix_bell_abbey")
...
REMEDIATIONS: dict[str, str] = {
    "Bell Morningside":             "https://www.bellmorningside.com/floor-plans/",
    "Bell Perimeter Center":        "https://www.bellperimetercenter.com/floorplans/",
    "Abbey at Eagles Landing, The": "https://www.abbeyresidential.com/apartments/ga/stockbridge/eagles-landing/floor-plans",
}
...
def main() -> None:
    ...
    for name, new_url in REMEDIATIONS.items():
        ...
        progress_record = {
            ...
            "notes": f"Bell/Abbey remediation: {pricing_info.get('notes', '')}; {scraper_note}",
    ...
    print("\n=== Bell/Abbey Remediation Summary ===")
    for r in results:
